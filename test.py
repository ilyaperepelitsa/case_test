...
test["sector_centroid_shift"] = (2*test["max_dist"] * np.sin(test["station_angle"])) / 3*test["station_angle"]

(2*test["max_dist"] * np.sin(test["station_angle"]))/ 3*test["station_angle"]
