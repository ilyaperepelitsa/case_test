...
pac_23 = [mpatches.Wedge(center = [x, y], r = radius, theta1=0, theta2=90, alpha = 0.7),
            mpatches.Wedge(center = [x, y], r = radius, theta1=90, theta2=end_angle, alpha = 0.7)
            mpatches.Wedge(center = [x, y], r = radius, theta1=start_angle, theta2=end_angle, alpha = 0.7)]
