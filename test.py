...
for x, i in test.drop_duplicates("cid").loc[ test.lac test.lac.unique()[1]].iterrows():
    # print(i["cid"])
    x = i["long"]
    y = i["lat"]
...
# pac_2 = mpatches.Wedge(center = [x + 0.1, y + 0.1], r = radius, theta1=0, theta2=35)
    pac_2 = mpatches.Wedge(center = [x, y], r = radius, theta1=start_angle, theta2=end_angle, alpha = 0.2)
