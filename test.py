...
[stack_events.loc[stack_events.combo_id == id_id & stack_events.tstamp.dt.date == date,["long", "lat"]],
stack_events.loc[stack_events.combo_id == id_id & stack_events.tstamp.dt.date == date,"lat"]) for date in stack_events.tstamp.dt.date.unique()]
