...
# new_cmap = rand_cmap(100, type='bright', first_color_black=True, last_color_black=False, verbose=True)
# len(new_cmap)
for ix, i in stack_events.loc[stack_events.combo_id == 0].drop_duplicates(["sector_centroid_lat", "sector_centroid_lon"]).loc[test.drop_duplicates("cid").index[700:750],:].iterrows():
# i = test.loc[test.index[900],:]
    # print(i["cid"])
    x = i["long"]
    y = i["lat"]
